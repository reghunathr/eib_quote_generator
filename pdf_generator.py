...
class QuotationPDF(FPDF):
    ...
    def footer(self) :
        HO_ADDRESS = "HO : PGRA 5, Plamood | Pattom P.O | Trivandrum | PIN: 695004 |PH: 7902748494"
    ...
    def add_disclaimer_and_contact(self):
        ...
        self.multi_cell (0,5,
            "The rates quoted above are from Bajaj General Insurance/IndusInd General Insurance. We work with leading insurers such as Tata AIG, Bajaj General Insurance, IndusInd  General Insurance, Future Generali and major Public Sector Companies" )
